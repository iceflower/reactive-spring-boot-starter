...
public class SingleDeferredResultTest {
  ...
  protected static class Application {
    ...
    public SingleDeferredResult<String> timeout() {
      return new SingleDeferredResult<String>(
          Single.timer(1, TimeUnit.MINUTES)
              .map(e -> "Single value"));
    }
  }
    ...
    class Context_with_retrieve_single_value_with_status_code {
      ...
      void it_returns_successfully() {
        ...
        ResponseEntity<String> response = restTemplate
            .getForEntity("/singleWithResponse", String.class);
        // then
        Assertions.assertNotNull(response);
