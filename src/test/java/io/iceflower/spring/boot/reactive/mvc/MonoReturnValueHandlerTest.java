...
@SpringBootTest(
    classes = MonoReturnValueHandlerTest.Application.class,
    webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT
)
@DisplayName("MonoReturnValueHandlerTest 클래스")
class MonoReturnValueHandlerTest {
  @Autowired
  ...
  class Describe_of_ingleReturnValueHandler {
    ...
    class Context_with_retrieve_single_value_with_status_code {
      ...
      void it_returns_successfully() {
        // when
        ResponseEntity<String> response = restTemplate.getForEntity("/monoWithResponse", String.class);
        // then
        Assertions.assertNotNull(response);
